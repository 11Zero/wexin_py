...
class wechatCallbackapi
{
    ...
    private function receiveText($object)
    {
        ...
        if (strstr($keyword, "文本")){
        ...
        }else if (strstr($keyword, "单图文")){//单图文已失效
            $content = array();
            ...
            $content = array();
            $content = array("Title"=>"岁月神偷", "Description"=>"歌手：金岐玟", "MusicUrl"=>"http://qqma.tingge123.com:83/123/2014/04/岁月神偷-金玟岐.mp3", "HQMusicUrl"=>"http://qqma.tingge123.com:83/123/2014/04/岁月神偷-金玟岐.mp3"); 
        }else{
